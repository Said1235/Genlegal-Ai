...
class SmartContractAuditor {
   ...
   * transaction to be ACCEPTED (consensus reached) before returning the
   * receipt; the new analysis id must then be read back via
   * getAllAnalyses/getMyAnalyses since GenLayer write calls return a
   * transaction hash, not the function's return value directly.
   */
