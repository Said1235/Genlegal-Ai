...
export type UrlReputation = "safe" | "suspicious" | "malicious" | "unknown";

export const reputationColor: Record<UrlReputation, string> = {
  safe: "#22c55e",
  suspicious: "#f59e0b",
  malicious: "#f43f5e",
  unknown: "#64748b",
...
export const reputationBadgeClass: Record<UrlReputation, string> = {
  safe: "bg-emerald-500/10 text-emerald-400 ring-1 ring-emerald-500/30",
  suspicious: "bg-amber-500/10 text-amber-400 ring-1 ring-amber-500/30",
  malicious: "bg-rose-500/10 text-rose-400 ring-1 ring-rose-500/30",
  unknown: "bg-slate-500/10 text-slate-400 ring-1 ring-slate-500/30",
};

export const reputationLabel: Record<UrlReputation, string> = {
  safe: "Safe",
