...
import { useDashboardData } from "@/lib/hooks/useSmartContractAuditor";
...
export default function AnalyticsPage() {
  ...
  const byType = useMemo(() => {
    ...
    for (const a of analyses) counts.set(a.language, (counts.get(a.language) || 0) + 1);
      ...
      {error ? (
        ...
        <>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-white/8 bg-bg-card/60 p-5">
              <h3 className="mb-5 text-[15px] font-semibold">Top Languages</h3>
