...
export const metadata: Metadata = {
  ...
  description:
    "GenLegal AI uses advanced AI and blockchain technology to analyze smart contract code, flag vulnerabilities, and score risk in seconds - verified on-chain with GenLayer consensus.",
};
