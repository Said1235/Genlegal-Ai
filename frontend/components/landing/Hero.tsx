...
const LINES = [
  { delay: 0,    text: "> Uploading Vault.sol...", type: "cmd" },
  { delay: 700,  text: "████████████████ 100%", type: "bar" },
  { delay: 1200, text: "✔ Reading contract structure...", type: "ok" },
  { delay: 1700, text: "✔ Mapping external calls...", type: "ok" },
  { delay: 2100, text: "✔ Checking access control...", type: "ok" },
  { delay: 2500, text: "✔ Running AI security scan...", type: "ok" },
  { delay: 3000, text: "─────────────────────────────", type: "div" },
  { delay: 3100, text: "⚠ HIGH   Reentrancy in withdraw()", type: "high" },
  { delay: 3500, text: "⚠ MEDIUM Missing zero-address check", type: "med" },
  { delay: 3900, text: "✔ LOW    Events emitted correctly", type: "low" },
  { delay: 4300, text: "─────────────────────────────", type: "div" },
  { delay: 4400, text: "Risk Score  ████████░░  82/100", type: "score" },
  { delay: 4800, text: "Completed in 4.8s  ·  3 findings", type: "done" },
];

const FINDINGS = [
  { delay: 1800, icon: "✓", text: "Ownable access control", color: "text-emerald-400" },
  { delay: 2300, icon: "✓", text: "Checks-effects-interactions", color: "text-emerald-400" },
  { delay: 2900, icon: "⚠", text: "Unchecked external call", color: "text-amber-400" },
  { delay: 3400, icon: "✓", text: "SafeMath / overflow checks", color: "text-emerald-400" },
  { delay: 3800, icon: "✗", text: "Reentrancy guard missing", color: "text-rose-400" },
];
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 py-16 sm:px-6 md:grid-cols-2 md:py-24 lg:gap-20 lg:py-28">
        ...
        <div className="order-2 text-center md:order-1 md:text-left">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-accent/30 bg-accent/10 px-4 py-1.5 text-xs font-medium text-accent-light">
            ...
            AI-Powered Smart Contract Security on Blockchain
          </div>

          <h1 className="text-4xl font-extrabold leading-[1.08] tracking-tight sm:text-5xl lg:text-[3.4rem]">
            Review Smart Contracts.
            <br />
            <span className="text-gradient">Catch Vulnerabilities.</span>
          </h1>

          <p className="mx-auto mt-6 max-w-lg text-[15px] leading-relaxed text-white/60 md:mx-0">
            GenLegal AI uses advanced AI and blockchain technology to analyze smart contract code, flag
            vulnerabilities, and score risk in seconds.
          </p>
