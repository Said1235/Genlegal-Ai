      ...
      <div className="flex flex-wrap items-start justify-between gap-4 border-b border-white/5 p-5">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {txHash && explorerBase ? (
            ...
            <span
              title="Transaction hash isn't stored on-chain - only available for analyses submitted from this browser"
              className="flex items-center gap-1.5 rounded-lg border border-white/5 px-3 py-1.5 text-xs font-medium text-white/30"
            >
              View on Explorer
              <ExternalLink className="h-3 w-3" />
            </span>
