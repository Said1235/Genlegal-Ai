    ...
    <div className="overflow-hidden rounded-2xl border border-white/8 bg-bg-card/60">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-0.5 text-xs text-white/40">
              {analysis.language} - Analyzed on {new Date(analysis.created_at).toLocaleString()}
            </p>
          </div>
        </div>
      ...
      <div className="grid gap-6 p-5 md:grid-cols-[1fr_220px]">
        <div>
          ...
          {tab === "recommendations" && (
            <div>
              <h4 className="mb-3 text-sm font-semibold text-white/80">Recommendations</h4>
              {analysis.recommendations.length === 0 ? (
                <p className="text-sm text-white/40">No specific recommendations were extracted.</p>
              ) : (
          ...
          {tab === "full" && (
            <div className="space-y-5">
              ...
              <div>
                <h4 className="mb-2 text-sm font-semibold text-white/80">Recommendations</h4>
          ...
          {tab === "metadata" && (
            <dl className="grid grid-cols-1 gap-4 text-sm sm:grid-cols-2">
              ...
              <div>
                ...
                <dd className="mt-0.5 text-white/80">{analysis.language}</dd>
              </div>
