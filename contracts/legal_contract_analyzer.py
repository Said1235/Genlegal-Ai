...
- Errors raised inside the non-deterministic block are tagged with
  ...
  leader's formatting alone. `get_my_analyses` applies the same
...
Base risk_score on concrete clauses you found (for example: unlimited liability, automatic renewal,
